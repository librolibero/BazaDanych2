...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty(trim($_POST["username"]))){
        $username_err = "Wpisz nazwe użytkownika.";
    } else{
    ...
    if(empty(trim($_POST["password"]))){
        ...
        $password_err = "Hasło musi mieć 6 znaków.";
    } else{
    ...
    <div class="wrapper">
        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
            ...
            <div class="form-group">
                <input type="potwierdz" class="btn btn-primary" value="Potwierdz">
                <input type="resetuj" class="btn btn-default" value="Resetuj">
            </div>
